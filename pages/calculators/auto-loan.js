...
import { ArrowUpRight, Calculator, DollarSign, Car, FileText, ArrowLeft, Shield, TrendingUp, Award } from 'lucide-react';
...
export default function AutoLoanCalculator() {
  ...
  const validateForm = () => {
    ...
    if (parseFloat(formData.downPayment) > parseFloat(formData.carPrice)) {
  ...
  const calculateAutoLoan = () => {
    ...
    const salesTaxRate = parseFloat(formData.salesTax) / 100;
    
    // Calculate total cost including tax
    const salesTax = carPrice * salesTaxRate;
    const totalCost = carPrice + salesTax;
    
    // Calculate loan amount
    const totalDownPayment = downPayment + tradeInValue;
    const loanAmount = totalCost - totalDownPayment;
    ...
    const downPaymentPercentage = (totalDownPayment / totalCost * 100).toFixed(1);
  ...
  const autoLoanFeatures = [
    {
      ...
      description: "Rates starting from 3.5% APR for qualified borrowers",
      color: "blue"
    },
    {
      icon: TrendingUp,
      title: "Flexible Terms",
      description: "Choose from 12 to 84-month repayment periods",
      color: "green"
    },
    {
      icon: Award,
      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 text-white">
          <div 
            ...
            style={{
              backgroundImage: 'url("https://images.unsplash.com/photo-1552519507-da3b142c1e3d?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80")'
            }}
          >
          ...
          <div className="relative container mx-auto px-6 pt-32 pb-20">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-light mb-6 leading-tight">
                Auto Loan<span className="text-blue-300 font-medium"> Calculator</span>
              </h1>
              <p className="text-xl md:text-2xl text-blue-100 leading-relaxed max-w-3xl mx-auto">
                Calculate your monthly car payments, total interest, and see a complete amortization schedule. Make informed decisions about your vehicle financing.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              >
                <h2 className="text-2xl font-medium text-slate-900 mb-6 flex items-center">
                  <Calculator className="w-6 h-6 mr-2 text-blue-600" />Auto Loan Details
                </h2>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    />
                    {errors.carPrice && (
                      <p className="mt-1 text-sm text-red-600">{errors.carPrice}</p>
                    )}
                  </div>
              ...
              >
                {results ? (
                  <>
                    <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-2xl border border-green-200">
                      <h3 className="text-2xl font-medium text-slate-900 mb-6 flex items-center">
                        <DollarSign className="w-6 h-6 mr-2 text-green-600" />Auto Loan Results
                      </h3>
                      
                      <div className="space-y-4">
                        <div className="flex justify-between items-center p-4 bg-white rounded-lg">
                          <span className="text-slate-600">Car Price</span>
                        ...
                        <div className="flex justify-between items-center p-4 bg-white rounded-lg">
                          ...
                          <span className="text-xl font-bold text-blue-600">
                            ${parseFloat(results.totalDownPayment).toLocaleString()}
                          </span>
                        </div>
                  ...
                  <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-200 text-center">
                    ...
                    <h3 className="text-xl font-medium text-slate-900 mb-2">Calculate Your Auto Loan</h3>
                    <p className="text-slate-600">Fill in the form to see your auto loan payment details and amortization schedule</p>
                  </div>
                )}
              </motion.div>
            </div>
            ...
            >
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-200">
                <h2 className="text-2xl font-medium text-slate-900 mb-6">Why Choose Our Auto Loan Solutions?</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {(autoLoanFeatures || []).map((feature) => (
            ...
            >
              <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-8 rounded-2xl shadow-xl text-center">
                ...
                <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
                  Take the next step towards your new vehicle with our streamlined auto loan application process. Get pre-approved in minutes.
                </p>
